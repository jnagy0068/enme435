...
VIDEO_FPS = 20
VIDEO_SIZE = (1280, 720)
videostr = os.path.join(SAVE_DIR, time.strftime("doorbell_recording-%Y%m%d-%H%M%S.avi"))
...
def video_thread(picam2):
    ...
    global latest_frame
    print(f"Video recording started — press Q in the preview window to stop & save.")
    print(f"Saving to: {videostr}")
